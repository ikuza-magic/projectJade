...
public class buttleCharaSpriteManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            stay[ani] = Resources.Load<Sprite>("Sprite/charaSprite/" + charaName + "/" + charaName + "_buttle_" + "stay_" + ani);
        }
        //進む
        for (int ani = 0; ani < 3; ani++)
        {
            go[ani] = Resources.Load<Sprite>("Sprite/charaSprite/" + charaName + "/" + charaName + "_buttle_" + "go_" + ani);
        }
        //アタック
        for (int ani = 0; ani < 4; ani++)
        {
            attack[ani] = Resources.Load<Sprite>("Sprite/charaSprite/" + charaName + "/" + charaName + "_buttle_" + "attack_" + ani);
        }
